    ...
    <tr>
        <td align="center" style="padding: 40px 0;">
            <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
                <tr>
                    <td align="center">
                        <h1 style="color: #333333;">Confirm Your Subscription</h1>
                        <p style="font-size: 16px; color: #555555;">
                            Thank you for subscribing to our weather updates!
                            Please confirm your subscription by clicking the button below.
                        </p>
                        <a href="{{ url("/api/confirm/{$token}") }}"
                           style="display: inline-block; margin-top: 20px; padding: 12px 24px; background-color: #007bff; color: #ffffff; text-decoration: none; border-radius: 5px;">
